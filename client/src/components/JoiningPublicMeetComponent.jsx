        ...
        <div className='flex justify-evenly w-full items-center gap-5 my-5 flex-col flex-wrap-reverse sm:flex-row'>
            ...
            <div>
                <div className='flex items-center flex-col sm:flex-row my-2'>
                    ...
                    />
                    <button type="button" className="transition-all ms-4 text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center justify-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30" >
                        Join
                    </button>
                </div>
                <p
