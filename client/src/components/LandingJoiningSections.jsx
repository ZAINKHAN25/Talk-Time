    ...
    return (
        <div className="flex flex-col justify-between items-center w-2/4">
            ...
            <div className="flex justify-between items-center w-4/6">
                ...
                <button type="button" className="w-2/4 text-white transition-all bg-[#2567D9]/70 hover:bg-[#2557D6] none font-medium rounded-lg text-sm px-5 py-2.5 text-center justify-center inline-flex items-center dark:focus:ring-[#2557D6]/50 me-2 mb-2">
                    Private Meet
                </button>
