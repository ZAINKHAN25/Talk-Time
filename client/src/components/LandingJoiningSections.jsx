    ...
    return (
        <div className="flex flex-col justify-between items-center w-2/4">
            ...
            <div className="rounded-full relative flex justify-center items-center shadow-gray-900 bg-gray-700 cursor-pointer transition-all hover:scale-110 hover:shadow-lg">
                ...
                <div className="absolute bottom-0 bg-slate-50 shadow-sm shadow-stone-300 text-gray-700 rounded-full">
                    <TiArrowSync size={23} />
                </div>
            </div>
            ...
            <button type="button"
                className="w-4/6 text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center justify-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mb-5">
                Quick Start
            </button>
            <div className="flex justify-between items-center w-4/6">
                <button type="button" className="w-2/4 text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Public Meets</button>
                <button type="button" className="w-2/4 text-white bg-[#2557D6] hover:bg-[#2567D9]/80 none font-medium rounded-lg text-sm px-5 py-2.5 text-center justify-center inline-flex items-center dark:focus:ring-[#2557D6]/50 me-2 mb-2">
                    Private Meet
                </button>
